...
export function Login() {
  ...
  const fetchSettingsData = useCallback(async () => {
    ...
    try {
      const APICalls = [
        {
          url: `${unauthUrlPath}/System/GetMileraMDSystemFile`,
          Type: "get",
          params: "",
          datafilterfunction: null,
        },
        {
          url: `${unauthUrlPath}/System/GetLogoMilera`,
          Type: "get",
          params: "",
          datafilterfunction: null,
        },
  ...
  const updateBackgroundImage = (ns, sns) => {
    const newBackgroundImage =
      window.innerWidth < 768 ? ns.mobBgImage : ns.bgImage;
  ...
  const handleNavigate = useCallback(
    async (data, isSU) => {
      ...
      if (state.showShortLogo)
        localStorage.setItem(
          "header",
          JSON.stringify({
            logo: state.shortLogo,
            hospName: state.hospitalName,
          })
        );
      ...
      if (isSU) {
        ...
        localStorage.setItem(
          "dischSumVersions",
          JSON.stringify(state.dischSumVersions)
        );
                ...
                <div className="col-12">
                  ...
                  <div className="row">
                    ...
                    <div id="loginTitle" className="col-12 mt-2">
                      ...
                      {state.showHosName && <div>{state.hospitalName}</div>}
                    </div>
                        ...
                        className={
                          ...
                          state.errorPswdTxt
                            ? state.errorLoginTxt ===
                              ...
                              ? "mb-3 bg-warning alert-text-danger-fc"
                              : "mb-3 alert-text-danger"
                            : "mb-3 text-muted"
                        }
                      >
                        {state.errorLoginTxt
                          ? state.errorLoginTxt
                          : state.errorUserTxt || state.errorPswdTxt
                  ...
                  <div className="input-group mb-2">
                    <span
                      className={`input-group-addon ${state.errorUserClass}`}
                    >
                    ...
                    <input
                      type="text"
                      ref={UsrRef}
                      className={`form-control ${state.errorUserClass}`}
                      placeholder="User Name"
                      value={state.username}
                      onChange={OnTextChange("UCode")}
                  ...
                  <div className="input-group mb-3">
                    <span
                      className={`input-group-addon ${state.errorPswdClass}`}
                    >
                    ...
                    <input
                      type="password"
                      ref={PwdRef}
                      className={`form-control ${state.errorPswdClass}`}
                      placeholder="Password"
                      value={state.password}
                      onChange={OnTextChange("Pass")}
                      onKeyDown={handleKeyDown}
                    />
                  </div>
